A very simple responsive web app that looks good-enough in mobile and desktop. It’s an app to search for movie titles and make a list of favourites from the results.
